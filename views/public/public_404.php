...
<link href="https://fonts.googleapis.com/css?family=Londrina+Sketch|Passero+One" rel="stylesheet">      
	 ...
	 <center>
		<div class="demo-card-square mdl-card mdl-shadow--2dp" style="margin-top: 25px;width: 90%;">
			<div style="padding-top: 20px;"">
				<h2 style="font-family: Londrina Sketch; font-size: 7em;">Error 404!</h2>
			</div>
			<div style="padding-top: 30px;">
				<div class="mdl-card__actions mdl-card--border"></div>
				<p style="font-family: Passero One; font-size: 3rem;">/*	NO Coffee, NO Code.	*/ </p>
			</div>
			<div class="sadface-wrapper" style="padding-bottom: 30px;">
